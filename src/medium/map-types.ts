...
// your answers
// inspired by https://github.com/type-challenges/type-challenges/issues/15915
type Include<
  T extends {
    mapFrom: any;
    mapTo: any;
  ...
  U
> = T extends {} ? (U extends T["mapFrom"] ? T["mapTo"] : never) : T["mapTo"];
...
> = {
  [K in keyof T]: T[K] extends R["mapFrom"] ? Include<R, T[K]> : T[K];
};
